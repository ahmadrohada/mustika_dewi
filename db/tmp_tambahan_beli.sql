...
--
-- Struktur dari tabel `tmp_tambahan_beli`
--

CREATE TABLE `tmp_tambahan_beli` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `tmp_tambahan_beli`
--
ALTER TABLE `tmp_tambahan_beli`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tmp_tambahan_beli`
--
ALTER TABLE `tmp_tambahan_beli`
