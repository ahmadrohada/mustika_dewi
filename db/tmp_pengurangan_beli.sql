...
--
-- Struktur dari tabel `tmp_pengurangan_beli`
--

CREATE TABLE `tmp_pengurangan_beli` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `tmp_pengurangan_beli`
--
ALTER TABLE `tmp_pengurangan_beli`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tmp_pengurangan_beli`
--
ALTER TABLE `tmp_pengurangan_beli`
