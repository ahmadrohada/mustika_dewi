...
--
-- Struktur dari tabel `tmp_pengurangan`
--

CREATE TABLE `tmp_pengurangan` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `tmp_pengurangan`
--
ALTER TABLE `tmp_pengurangan`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tmp_pengurangan`
--
ALTER TABLE `tmp_pengurangan`
