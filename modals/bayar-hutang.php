<div class="modal fade bayar-hutang" id="bayarHutang" role="dialog"  aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <form  id="form-bayar-hutang" method="POST" action="">
                        <input type="hidden" class="" value="bayar_hutang" name="op">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group nama ">
                                    ...
                                    <input  class="form_bayar form-control total_pembelian" name="" id="" style="text-align:right">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group nama ">
                                    ...
                                    <input type="text" class="form_bayar form-control input-sm sisa_hutang"  value="" id="sisa_hutang" style="text-align:right;">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group nama ">
...
$(document).ready(function() {
    ...
    $('.bayar-hutang').on('shown.bs.modal', function () {
...
//================= SIMPAN ITEM PEMBELIAN =============================//
    ...
    $(document).on('click', '#simpan_pembayaran', function(){
       ...
       if ( jumlah_bayar !=  "" ){
            ...
            var data = $('#form-bayar-hutang').serialize();

            $.ajax({
                url     :"./kelas/hutang_post.php",
                type	: 'POST',
                data	:  data,
