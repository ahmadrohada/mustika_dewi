<div class="modal fade detail_bayar-hutang" id="bayarHutang" role="dialog"  aria-hidden="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group nama ">
                                    ...
                                    <input  class="form_bayar form-control s_total_pembelian" name="" id="" style="text-align:right">
                                </div>
                            </div>
                        </div>
