    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa  fa-th-list"></i> Retur Penjualan</h3>
                </div>
                <div class="box-body">
    ...
    function load_data_penjualan(no_nota){
		...
		$.ajax({
			...
			success     : function(data) {
                    ...
                    $('.total_retur').val(data['detail_penjualan_list'][0]['total_retur']);
...
$(document).on('keydown','.qty_retur',function(e){
    ...
    function update_qty_table(id,qty){
        ...
        $.ajax({
                ...
                type        : "POST",
                data        :{op:"update_qty_retur_penjualan",qty:qty,no_nota:no_nota,keterangan:keterangan,status_retur:status_retur},
                cache       :false,
                success:function(data){
                    load_data();
                },
...
$(document).on('keydown','.keterangan',function(e){
    ...
    function update_ket_table(){
        ...
        $.ajax({
                url         :"./kelas/item_post.php",
                type        : "POST",
                data        :{op:"update_keterangan_retur_penjualan",no_nota:no_nota,keterangan:keterangan,status_retur:status_retur},
                cache       :false,
                success:function(data){
                    load_data();
                },
