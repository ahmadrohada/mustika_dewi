<?php
    $retur_penjualan_id = isset($_GET['retur_penjualan_id']) ? $_GET['retur_penjualan_id'] : '';
?>
<input type="hidden" value="<?php echo $retur_penjualan_id ?>" class="retur_penjualan_id" id="retur_penjualan_id" name="retur_penjualan_id" >
...
$(document).ready(function () {
    ...
    retur_penjualan_id = $('.retur_penjualan_id').val();
    
    $.ajax({
			url         : "./kelas/penjualan_get.php",
			type        : "GET",
			dataType    : "json",
			data        : {data:'detail_retur_transaksi_penjualan',retur_penjualan_id:retur_penjualan_id},
			success     : function(data) {
                ...
                load_data_retur_penjualan(data['no_nota']);
                load_detail_penjualan(data['penjualan_id']);
    ...
    function load_detail_penjualan(penjualan_id){
        $.ajax({
                url         : "./kelas/penjualan_get.php",
                type        : "GET",
                dataType    : "json",
    ...
    //======================== RETUR TABLE   ===================================//
    $('#list_retur_penjualan').bootstrapTable({
		columns:[	
				{
					field: 'no',
					title: 'NO',
    ...
    function load_data_retur_penjualan(no_nota){
		
		$.ajax({
			url         : "./kelas/penjualan_get.php",
			type        : "GET",
			dataType    : "json",
			data        : {data:'transaksi_retur_penjualan_list_item',no_nota:no_nota},
			success     : function(data) {
				
                    $('#list_retur_penjualan').bootstrapTable('load',{data: data['retur_penjualan_list'] });
			...
			error: function(data){
					$('#list_retur_penjualan').bootstrapTable('removeAll');
					$('.fixed-table-loading').fadeOut(100);
					$('[data-toggle="tooltip"]').tooltip();
